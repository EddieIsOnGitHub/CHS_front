    ...
    >
      ...
      >
        {items.map((item, i) => (
          <div
            key={i}
            className="flex items-center justify-center p-3 text-base md:text-lg 
             font-medium text-center border border-gray-300 
             rounded-xl select-none box-border relative"
            style={{
